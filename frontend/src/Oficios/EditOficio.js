...
const EditOficio = (props) => {
    ...
    const [currentTemplate, setCurrentTemplate] = useState(2); // Controla o template ativo (1 ou 2)
...
`;
    ...
    const getTemplate2SecondPage = () => {
        ...
        const textHeight = calculateTextHeight(textopart2); // Function to calculate the text height
...
<td style="visibility: hidden;
    ...
    const handleSaveOrUpdate = async () => {
        ...
        if (inputValue === "Não tem obra") {
            ...
            console.log(NomeDestinatario);
            nomeDonoObra = NomeDestinatario || "";
            moradaDonoObra = Morada || "";
            localidadeDonoObra = Localidade || "";
            codPostalDonoObra = CodPostal || "";
            codPostalLocalDonoObra = CodPostalLocal || "";

            obraSlecionadaSave = obraUP || "";
        ...
        const part2Chunks = splitText(textopart2 || "");
        // Payload comum para criação e atualização
        console.log(anexostext);
        const payloadDoc = {
            ...formData,
            codigo: codigo || "",
            assunto: assunto,
    ...
    const goBackToOficiosList = () => {
        navigation.reset({
            index: 0,
            routes: [{ name: 'OficiosList' }], // Reset stack with OficiosList
        });
    };
    return (
                ...
                <div style={{ width: "60%", margin: "0 auto", padding: "20px", backgroundColor: "#ffffff", borderRadius: "12px", boxShadow: "0 4px 10px rgba(0, 0, 0, 0.1)" }}>
                    ...
                    />
                        ...
                        <textarea
                            ...
                            maxLength={1600}  // Limite de 1020 caracteres
                            style={{
                                width: "100%",
                                padding: "12px",
                                margin: "10px 0",
