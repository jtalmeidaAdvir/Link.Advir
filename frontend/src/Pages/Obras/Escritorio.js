...
const Escritorio = ({ navigation }) => {
        ...
        <View style={styles.headerContainer}>
            ...
            >
                ...
                >
                    ...
                    />
                    <Text style={styles.headerTitle}>Gestão de Escritórios</Text>
                    <Text style={styles.headerSubtitle}>
                        {filteredObras.length} escritório
                        {filteredObras.length !== 1 ? "s" : ""} encontrado
        ...
        >
            <View style={styles.searchInputContainer}>
                ...
                <TextInput
                    ...
                    placeholder="Procurar escritório..."
    ...
    <div class="print-wrapper">
        <h1>${item.Codigo}</h1>
        <h1>${item.Titulo}</h1>
        <img src="${qrCodeSrc}" alt="QR Code do Escritório" />
    </div>
</body>
...
`);
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            if (!obraExistente) {
                                                alert(
                                                    "Este escritório ainda não foi importado.",
                                                );
                                                return;
                                            }
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
                {searchTerm
                    ? `Não foram encontrads escritórios para "${searchTerm}"`
                    : "Ainda não existem escritórios registadas"}
            </Text>
        </View>
    );
