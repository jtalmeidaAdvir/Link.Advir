    ...
    empresa_areacliente, // Verifique se este campo está correto
        ...
        const mailOptions = {
            ...
            <div style="font-family: Arial, sans-serif; text-align: center;">
                ...
                <a href="${verificationLink}" style="background-color: #0022FF; color: white; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block; margin: 20px 0;">Verifica a minha Conta</a>
                <p style="font-size: 14px; color: #333;">Se tiveres alguma questão ou precisares de ajuda, não hesites em contactar a <a href="mailto:support@advir.pt" style="color: #0022FF;">equipa de suporte</a>.</p>
