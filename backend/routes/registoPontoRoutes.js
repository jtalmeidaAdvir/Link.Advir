...
const { registarLeituraQRCode, getRegistoDiario,editarRegisto,registarPontoComBotao, listarHistoricoPontoAdmin, obterEstadoPonto } = require('../controllers/registoPontoController');
